...
public class MyLatex {
    private String text = "double g=12.546.;int f=23ee-19\nif(a==1)i=2;\n //test";
    ...
    public static void main(String[] args) {
        MyLatex test=new MyLatex("19\nif(a==1)i=2;\n //test");
        test.LetexAnalyze();
        test.GetAnimatePos();
    }
    public MyLatex(String str){text=str;}
    public void GetAnimatePos(){
        ...
        for (int line = 2 ; line <= tempText.length; line++) lineStartPos[line]=lineStartPos[line-1]+tempText[line-2].length()+1;
